    ...
    // Step 3: Aguardando "Ta pagando quanto?"
    {
      ...
      afterResponse: () => {
        ...
        setTimeout(() => {
          ...
          // Marca o step 1 (Negociação) como concluído e move para o step 2 (Documentos)
          setCompletedTabs(prev => prev.includes(1) ? prev : [...prev, 1]);
          setCurrentStep(2);
        }, 2000);
      }
                    ...
                    <div className="trip-confirmed-message">
                      ...
                      <div className="trip-caption">
                        <div className="trip-title">
                          {contactId && contacts[contactId] && contacts[contactId].name} confirmou a viagem!
                          {freight && (
                            <>
                              <br /><br />
                              📍 {freight.origin.split(', ')[1]} → {freight.destination.split(', ')[1]} | {freight.product}
                              <br /><br />
          ...
          messages.some(msg => msg.type === 'trip-confirmed') ? (
            <div className="pix-copy-bar">
              ...
              <button className="pix-copy-button">
                <span className="button-label">Enviar Pix</span>
